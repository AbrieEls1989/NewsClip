(function(i) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(g) { return i(g, window, document) }) : "object" === typeof exports ? module.exports = function(g, k, q, r) { g || (g = window); if (!k || !k.fn.dataTable) k = require("datatables.net")(g, k).$;
        k.fn.dataTable.Buttons || require("datatables.net-buttons")(g, k); return i(k, g, g.document, q, r) } : i(jQuery, window, document) })(function(i, g, k, q, r, p) {
    function y(a, c) {
        ...
        i.each(c, function(c, b) {
            if (i.isPlainObject(b)) { var e = a.folder(c);
                y(e, b) } else {
                if (s) { var e = b.childNodes[0],
                        f, h, m = []; for (f = e.attributes.length - 1; 0 <= f; f--) { h = e.attributes[f].nodeName; var g = e.attributes[f].nodeValue; - 1 !== h.indexOf(":") && (m.push({ name: h, value: g }), e.removeAttribute(h)) }
                    f = 0; for (h = m.length; f < h; f++) g = b.createAttribute(m[f].name.replace(":", "_dt_b_namespace_token_")), g.value = m[f].value, e.setAttributeNode(g) }
    ...
    function n(a, c, d) { var b = a.createElement(c);
    ...
    function I(a, c) {
        ...
        for (var e = 0, f = a.body.length; e < f && !(b = a.body[e][c].toString(), -1 !== b.indexOf("\n") ? (b = b.split("\n"),
                b.sort(function(a, b) { return b.length - a.length }), b = b[0].length) : b = b.length, b > d && (d = b), 40 < d); e++);
        d *= 1.3;
        return 6 < d ? d : 6
    }
    ...
    if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) o = void 0;
        ...
        var t = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
            ...
            C = function(a) { return /^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(a.type) ? new Blob([String.fromCharCode(65279), a], { type: a.type }) : a },
            D = function(a, c, d) {
                d || (a = C(a));
                var b = this,
                    ...
                    e, f = function() {
                        for (var a = ["writestart", "progress", "write", "writeend"],
                                a = [].concat(a), c = a.length; c--;) { var d = b["on" + a[c]]; if ("function" === typeof d) try { d.call(b, b) } catch (e) { L(e) } }
                    };
                b.readyState = b.INIT;
                if (J) e = (h.URL || h.webkitURL || h).createObjectURL(a), setTimeout(function() { t.href = e;
                    t.download = c; var a = new MouseEvent("click");
                    t.dispatchEvent(a);
                    f();
                    B(e);
                    b.readyState = b.DONE });
            ...
            j = D.prototype;
        "undefined" !== typeof navigator && navigator.msSaveOrOpenBlob ? o = function(a, c, d) { c = c || a.name || "download";
            d || (a = C(a)); return navigator.msSaveOrOpenBlob(a, c) } : (j.abort = function() {}, j.readyState = j.INIT = 0, j.WRITING = 1, j.DONE = 2, j.error = j.onwritestart = j.onprogress = j.onwrite = j.onabort = j.onerror = j.onwriteend =
            null, o = function(a, c, d) { return new D(a, c || a.name || "download", d) })
    }
    l.fileSave = o;
    var u = function(a, c) { var d = "*" === a.filename && "*" !== a.title && a.title !== p ? a.title : a.filename; "function" === typeof d && (d = d()); - 1 !== d.indexOf("*") && (d = i.trim(d.replace("*", i("title").text())));
            d = d.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, ""); return c === p || !0 === c ? d + a.extension : d },
        ...
        E = function(a) { return a.newline ? a.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n" },
        F = function(a, c) {
            for (var d = E(c), b = a.buttons.exportData(c.exportOptions), e = c.fieldBoundary, f = c.fieldSeparator, i = RegExp(e, "g"), m = c.escapeChar !== p ? c.escapeChar : "\\", h = function(a) { for (var b = "", c = 0, d = a.length; c < d; c++) 0 < c && (b += f), b += e ? e + ("" + a[c]).replace(i, m + e) + e : a[c]; return b }, g = c.header ? h(b.header) + d : "", k = c.footer && b.footer ? d +
        ...
        action: function(a, c, d, b) {
            ...
            if (k.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (f) { c.buttons.info(c.i18n("buttons.copyTitle", "Copy to clipboard"), c.i18n("buttons.copySuccess", { 1: "Copied one row to clipboard", _: "Copied %d rows to clipboard" }, a.rows), 2E3); return }
                } catch (h) {}
            }
            ...
            i(k).on("keydown.buttons-copy", function(a) { 27 === a.keyCode && g() }).on("copy.buttons-copy cut.buttons-copy", function() { g() })
        },
        exportOptions: {},
        fieldSeparator: "\t",
        fieldBoundary: "",
    ...
    l.ext.buttons.csvHtml5 = {
        ...
        available: function() { return g.FileReader !== p && g.Blob },
        text: function(a) {
            return a.i18n("buttons.csv",
                "CSV")
        },
        action: function(a, c, d, b) { a = F(c, b).str;
            c = b.charset;
            b.customize && (a = b.customize(a, b));!1 !== c ? (c || (c = k.characterSet || k.charset), c && (c = ";charset=" + c)) : c = "";
            b.bom && (a = "﻿" + a);
    ...
    l.ext.buttons.excelHtml5 = {
        ...
        available: function() { return g.FileReader !== p && (q || g.JSZip) !== p && !G() && v },
        text: function(a) {
        ...
        action: function(a, c, d, b) {
            var e = 0,
                a = function(a) { return i.parseXML(z[a]) },
                    ...
                    for (var b = 0,
                        ...
                        if (!(null === a[b] || a[b] === p || "" === a[b])) {
                            ...
                            for (var l = 0, o = H.length; l < o; l++)
                                if (g = H[l], a[b].match && a[b].match(g.match)) { j = a[b].replace(/[^\d\.\-]/g, "");
                                    g.fmt && (j = g.fmt(j));
                                    j = n(f, "c", { attr: { r: d, s: g.style }, children: [n(f, "v", { text: j })] }); break }
                            j || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ? j = n(f, "c", {
                                attr: { t: "n", r: d },
                                children: [n(f,
                                    "v", { text: a[b] })]
                            }) : (g = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""), j = n(f, "c", { attr: { t: "inlineStr", r: d }, children: { row: n(f, "is", { children: { row: n(f, "t", { text: g }) } }) } })));
                            k.appendChild(j)
                        }
                    }
                    h.appendChild(k);
            ...
            j = 0;
            for (l = c.header.length; j < l; j++) d.appendChild(n(f, "col", { attr: { min: j + 1, max: j + 1, width: I(c, j), customWidth: 1 } }));
            b.customize && b.customize(a);
            c = new(q || g.JSZip);
            d = { type: "blob", mimeType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" };
            y(c, a);
            c.generateAsync ? c.generateAsync(d).then(function(a) { o(a, u(b)) }) : o(c.generate(d), u(b))
        },
        filename: "*",
        extension: ".xlsx",
        exportOptions: {},
    ...
    l.ext.buttons.pdfHtml5 = {
        ...
        available: function() { return g.FileReader !== p && (r || g.pdfMake) },
        text: function(a) { return a.i18n("buttons.pdf", "PDF") },
        action: function(a, c, d, b) {
            E(b);
            var a = c.buttons.exportData(b.exportOptions),
                e = [];
            b.header && e.push(i.map(a.header, function(a) { return { text: "string" === typeof a ? a : a + "", style: "tableHeader" } }));
            for (var f = 0, h = a.body.length; f < h; f++) e.push(i.map(a.body[f], function(a) { return { text: "string" === typeof a ? a : a + "", style: f % 2 ? "tableBodyEven" : "tableBodyOdd" } }));
            ...
            a = { pageSize: b.pageSize, pageOrientation: b.orientation, content: [{ table: { headerRows: 1, body: e }, layout: "noBorders" }], styles: { tableHeader: { bold: !0, fontSize: 11, color: "white", fillColor: "#2d4154", alignment: "center" }, tableBodyEven: {}, tableBodyOdd: { fillColor: "cadetblue" }, tableFooter: { bold: !0, fontSize: 11, color: "white", fillColor: "#2d4154" }, title: { alignment: "center", fontSize: 15 }, message: {} }, defaultStyle: { fontSize: 10 } };
            ...
            "open" === b.download && !G() ? c.open() : c.getBuffer(function(a) { a = new Blob([a], { type: "application/pdf" });
                o(a, u(b)) })
        },
        title: "*",
        filename: "*",
